...
class Imagecode{
        ...
        private $fonturl;
        private $session;
        function __construct($width = 120,$height = 30,$counts = 5,$distrubcode="1235467890qwertyuipkjhgfdaszxcvbnm",$fonturl="C:\Windows\Fonts\baidusd_number_new.ttf"){
            $this->width=$width;
            $this->height=$height;
            $this->counts=$counts;
        ...
        private function set_code($im){
            ...
            $fontsize=rand(30,35);
            $fonturl="C:\Windows\Fonts\baidusd_number_new.ttf";//$this->fonturl;
